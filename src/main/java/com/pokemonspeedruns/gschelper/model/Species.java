...
public enum Species {
    ...
    static {
        ...
        evoFamilies.addFamily(CATERPIE, METAPOD, BUTTERFREE);
        evoFamilies.addFamily(WEEDLE, KAKUNA, BEEDRILL);
        evoFamilies.addFamily(PIDGEY, PIDGEOTTO, PIDGEOT);
        evoFamilies.addFamily(RATTATA, RATICATE);
        evoFamilies.addFamily(SPEAROW, FEAROW);
        evoFamilies.addFamily(EKANS, ARBOK);
        evoFamilies.addFamily(PICHU, PIKACHU, RAICHU);
        evoFamilies.addFamily(SANDSHREW, SANDSLASH);
        evoFamilies.addFamily(NIDORANF, NIDORINA, NIDOQUEEN);
        evoFamilies.addFamily(NIDORANM, NIDORINO, NIDOKING);
        evoFamilies.addFamily(CLEFFA, CLEFAIRY, CLEFABLE);
        evoFamilies.addFamily(VULPIX, NINETALES);
        evoFamilies.addFamily(IGGLYBUFF, JIGGLYPUFF, WIGGLYTUFF);
        evoFamilies.addFamily(ZUBAT, GOLBAT, CROBAT);
        evoFamilies.addFamily(ODDISH, GLOOM, VILEPLUME);
        evoFamilies.addFamily(ODDISH, GLOOM, BELLOSSOM);
        evoFamilies.addFamily(PARAS, PARASECT);
        evoFamilies.addFamily(VENONAT, VENOMOTH);
        evoFamilies.addFamily(DIGLETT, DUGTRIO);
        evoFamilies.addFamily(MEOWTH, PERSIAN);
        evoFamilies.addFamily(PSYDUCK, GOLDUCK);
        evoFamilies.addFamily(MANKEY, PRIMEAPE);
        evoFamilies.addFamily(GROWLITHE, ARCANINE);
        evoFamilies.addFamily(POLIWAG, POLIWHIRL, POLIWRATH);
        evoFamilies.addFamily(POLIWAG, POLIWHIRL, POLITOED);
        evoFamilies.addFamily(ABRA, KADABRA, ALAKAZAM);
        evoFamilies.addFamily(MACHOP, MACHOKE, MACHAMP);
        evoFamilies.addFamily(BELLSPROUT, WEEPINBELL, VICTREEBEL);
        evoFamilies.addFamily(TENTACOOL, TENTACRUEL);
        evoFamilies.addFamily(GEODUDE, GRAVELER, GOLEM);
        evoFamilies.addFamily(PONYTA, RAPIDASH);
        evoFamilies.addFamily(SLOWPOKE, SLOWBRO);
        evoFamilies.addFamily(SLOWPOKE, SLOWKING);
        evoFamilies.addFamily(MAGNEMITE, MAGNETON);
        evoFamilies.addFamily(FARFETCHD);
        evoFamilies.addFamily(DODUO, DODRIO);
        evoFamilies.addFamily(SEEL, DEWGONG);
        evoFamilies.addFamily(GRIMER, MUK);
        evoFamilies.addFamily(SHELLDER, CLOYSTER);
        evoFamilies.addFamily(GASTLY, HAUNTER, GENGAR);
        evoFamilies.addFamily(ONIX, STEELIX);
        evoFamilies.addFamily(DROWZEE, HYPNO);
        evoFamilies.addFamily(KRABBY, KINGLER);
        evoFamilies.addFamily(VOLTORB, ELECTRODE);
        evoFamilies.addFamily(EXEGGCUTE, EXEGGUTOR);
        evoFamilies.addFamily(CUBONE, MAROWAK);
        evoFamilies.addFamily(TYROGUE, HITMONLEE);
        evoFamilies.addFamily(TYROGUE, HITMONCHAN);
        evoFamilies.addFamily(TYROGUE, HITMONTOP);
        evoFamilies.addFamily(LICKITUNG);
        evoFamilies.addFamily(KOFFING, WEEZING);
        evoFamilies.addFamily(RHYHORN, RHYDON);
        evoFamilies.addFamily(CHANSEY, BLISSEY);
        evoFamilies.addFamily(TANGELA);
        evoFamilies.addFamily(KANGASKHAN);
        evoFamilies.addFamily(HORSEA, SEADRA, KINGDRA);
        evoFamilies.addFamily(GOLDEEN, SEAKING);
        evoFamilies.addFamily(STARYU, STARMIE);
        evoFamilies.addFamily(MRMIME);
        evoFamilies.addFamily(SCYTHER, SCIZOR);
        evoFamilies.addFamily(SMOOCHUM, JYNX);
        evoFamilies.addFamily(ELEKID, ELECTABUZZ);
        evoFamilies.addFamily(MAGBY, MAGMAR);
        evoFamilies.addFamily(PINSIR);
        evoFamilies.addFamily(TAUROS);
        evoFamilies.addFamily(MAGIKARP, GYARADOS);
        evoFamilies.addFamily(LAPRAS);
        evoFamilies.addFamily(DITTO);
        evoFamilies.addFamily(EEVEE, VAPOREON);
        evoFamilies.addFamily(EEVEE, JOLTEON);
        evoFamilies.addFamily(EEVEE, FLAREON);
        evoFamilies.addFamily(EEVEE, ESPEON);
        evoFamilies.addFamily(EEVEE, UMBREON);
        evoFamilies.addFamily(PORYGON, PORYGON2);
        evoFamilies.addFamily(OMANYTE, OMASTAR);
        evoFamilies.addFamily(KABUTO, KABUTOPS);
        evoFamilies.addFamily(AERODACTYL);
        evoFamilies.addFamily(SNORLAX);
        evoFamilies.addFamily(ARTICUNO);
        evoFamilies.addFamily(ZAPDOS);
        evoFamilies.addFamily(MOLTRES);
        ...
        evoFamilies.addFamily(SPINARAK, ARIADOS);
        evoFamilies.addFamily(CHINCHOU, LANTURN);
        evoFamilies.addFamily(TOGEPI, TOGETIC);
        evoFamilies.addFamily(NATU, XATU);
        evoFamilies.addFamily(MAREEP, FLAAFFY, AMPHAROS);
        evoFamilies.addFamily(MARILL, AZUMARILL);
        evoFamilies.addFamily(SUDOWOODO);
        evoFamilies.addFamily(HOPPIP, SKIPLOOM, JUMPLUFF);
        evoFamilies.addFamily(AIPOM);
        evoFamilies.addFamily(SUNKERN, SUNFLORA);
        evoFamilies.addFamily(YANMA);
        evoFamilies.addFamily(WOOPER, QUAGSIRE);
        evoFamilies.addFamily(MURKROW);
        evoFamilies.addFamily(MISDREAVUS);
        evoFamilies.addFamily(UNOWN);
        evoFamilies.addFamily(WOBBUFFET);
        evoFamilies.addFamily(GIRAFARIG);
        evoFamilies.addFamily(PINECO, FORRETRESS);
        evoFamilies.addFamily(DUNSPARCE);
        evoFamilies.addFamily(GLIGAR);
        evoFamilies.addFamily(SNUBBULL, GRANBULL);
        evoFamilies.addFamily(QWILFISH);
        evoFamilies.addFamily(SHUCKLE);
        evoFamilies.addFamily(HERACROSS);
        evoFamilies.addFamily(SNEASEL);
        evoFamilies.addFamily(TEDDIURSA, URSARING);
        evoFamilies.addFamily(SLUGMA, MAGCARGO);
        evoFamilies.addFamily(SWINUB, PILOSWINE);
        evoFamilies.addFamily(CORSOLA);
        evoFamilies.addFamily(REMORAID, OCTILLERY);
        evoFamilies.addFamily(DELIBIRD);
        evoFamilies.addFamily(MANTINE);
        evoFamilies.addFamily(SKARMORY);
        evoFamilies.addFamily(HOUNDOUR, HOUNDOOM);
        evoFamilies.addFamily(PHANPY, DONPHAN);
        evoFamilies.addFamily(STANTLER);
        evoFamilies.addFamily(SMEARGLE);
        evoFamilies.addFamily(MILTANK);
        evoFamilies.addFamily(RAIKOU);
        evoFamilies.addFamily(ENTEI);
        evoFamilies.addFamily(SUICUNE);
        evoFamilies.addFamily(LARVITAR, PUPITAR, TYRANITAR);
        evoFamilies.addFamily(LUGIA);
        evoFamilies.addFamily(HOOH);
        evoFamilies.addFamily(CELEBI);
    }
}
