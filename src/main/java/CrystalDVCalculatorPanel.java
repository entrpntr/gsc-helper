...
public class CrystalDVCalculatorPanel extends GSCDVCalculatorPanel {
    ...
    public void init() {
        ...
        buttonPidgeyL2.setFont(new Font(getFontName(), Font.BOLD, 14));
        ...
        buttonPidgeyL3.setFont(new Font(getFontName(), Font.BOLD, 14));
        ...
        buttonPidgeyL4.setFont(new Font(getFontName(), Font.BOLD, 14));
        ...
        buttonSentretL2.setFont(new Font(getFontName(), Font.BOLD, 14));
        ...
        buttonSentretL3.setFont(new Font(getFontName(), Font.BOLD, 14));
        ...
        buttonHoppipL3.setFont(new Font(getFontName(), Font.BOLD, 14));
        ...
        buttonHoppipL4.setFont(new Font(getFontName(), Font.BOLD, 14));
        ...
        buttonCaterpieL3.setFont(new Font(getFontName(), Font.BOLD, 14));
        ...
        buttonCaterpieL4.setFont(new Font(getFontName(), Font.BOLD, 14));
        ...
        buttonRattataL2.setFont(new Font(getFontName(), Font.BOLD, 14));
        ...
        this.labelPoliwagAmount.setFont(new Font(getFontName(), Font.BOLD, 20));
        ...
        buttonPoliwagL4.setFont(new Font(getFontName(), Font.BOLD, 14));
        ...
        labelGordon.setFont(new Font(getFontName(),Font.BOLD,11));
        ...
        buttonGordonWooperL10.setFont(new Font(getFontName(), Font.BOLD, 12));
        ...
        labelBill.setFont(new Font(getFontName(),Font.BOLD,11));
        this.add(labelBill);
        ...
        buttonBillKoffingL6_1.setFont(new Font(getFontName(), Font.BOLD, 12));
        ...
        buttonBillKoffingL6_2.setFont(new Font(getFontName(), Font.BOLD, 12));
        ...
        labelAnthony.setFont(new Font(getFontName(),Font.BOLD,11));
        ...
        buttonAnthonyGeodudeL11.setFont(new Font(getFontName(), Font.BOLD, 12));
        ...
        buttonAnthonyMachopL11.setFont(new Font(getFontName(), Font.BOLD, 12));
        ...
        labelGrunt.setFont(new Font(getFontName(),Font.BOLD,11));
        this.add(labelGrunt);
        ...
        buttonGruntRattataL9_1.setFont(new Font(getFontName(), Font.BOLD, 12));
        ...
        buttonGruntRattataL9_2.setFont(new Font(getFontName(), Font.BOLD, 12));
